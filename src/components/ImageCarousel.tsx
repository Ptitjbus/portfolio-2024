...
const ImageCarousel = ({
    ...
    return (
        <div className={`relative group w-full ${className}`}>
            <div className="overflow-hidden bg-gray-100 lg:rounded-lg lg:border-2 lg:border-gray-300" ref={emblaRef}>
                <div className="flex">
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="0" strokeLinecap="round" strokeLinejoin="round"><path d="m15 18-6-6 6-6" /></svg>
            </button>
            <button
                onClick={scrollNext}
                ...
                aria-label="Suivant"
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="0" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6" /></svg>
            </button>
            ...
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex justify-center gap-2 items-center">
                {images.map((_, index) => (
                    <button
                        ...
                        className={`w-2 h-2 lg:w-3 lg:h-3 transition-all rounded-full ${selectedIndex === index ? "bg-sky-400 scale-125" : "bg-sky-200 scale-100"
                            }`}
