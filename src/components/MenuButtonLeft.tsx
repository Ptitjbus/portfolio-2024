...
export default function MenuButtonLeft() {
  return (
    <div className="fade-in-left z-10 absolute p-2 flex justify-end gap-4 shadow-md hover:shadow-lg rounded-full bg-gray-200 w-[270px] bottom-12 -left-28 sm:bottom-10 sm:-left-30">
