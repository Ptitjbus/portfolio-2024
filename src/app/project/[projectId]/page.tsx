            ...
            <div className="flex flex-col gap-4 lg:h-full">
                <div className="flex justify-between w-full border-b-2 border-gray-300">
                    ...
                    <div className="pr-6 md:pr-32 text-gray-500 text-2xl md:text-5xl font-bold">
                        <span className=" italic tracking-wide">{page.data.project_name}</span>
                    </div>
                </div>
                <div
                    className="flex lg:flex-row flex-col-reverse gap-4 h-full relative bg-[var(--bg-gradient-color)]">
                    <PrismicNextImage
                    ...
                    <div className="lg:fade-in-right flex flex-col lg:w-1/2 justify-center xl:p-10 lg:p-6 p-0 lg:gap-8 gap-4 z-10">
                        ...
                        >
                            {page.data.links_group.map((item, index) => (
                                item.link !== null && item.link_display_text !== null && (
