        ...
        <main className="transition-all h-full fixed w-screen overflow-x-hidden bg-gray-200 flex flex-col py-12 gap-1">
            ...
            <div className="flex justify-between w-full border-b-2 border-gray-300">
                ...
                <div className="pr-6 md:pr-32 text-gray-500 text-2xl md:text-5xl font-bold">
                    About{" "}
                    <span className="text-sky-400 italic tracking-wide">
                        Me
                    </span>
                </div>
            </div>
            <div className="flex flex-col-reverse lg:h-full lg:flex-row border-y-2 border-gray-300 bg-gradient-to-tr from-sky-300 via-sky-400 to-sky-500">
                <div className="flex min-h-[75vh] flex-col justify-between gap-12 w-full h-full p-6 md:p-14">
                    <div className="lg:p-4 lg:border-2 lg:border-gray-300 rounded-lg lg:bg-gray-200 h-full lg:text-gray-700 text-gray-800 text-xl xl:text-2xl flex flex-col gap-5 text-pretty">
                ...
                <div className="flex flex-col gap-4 w-full lg:p-14 p-6">
                    <div className="h-2/3 relative">
                        <PrismicNextImage
                            field={page.data.image}
                            className="h-full object-cover rounded-2xl"
                        />
                        <div className="absolute bottom-0 right-0 w-full h-full flex flex-col items-end justify-end pb-10 lg:gap-1 overflow-clip">
                            <div className="text-2xl sm:text-6xl lg:pr-6 pr-2 font-bold tracking-wide flex text-gray-200 font-outline-2 fade-in-left-1">
                                About{" "}
                                <span className="italic tracking-wide">Me</span>
                            </div>
                            <div className="w-full lg:h-3 h-2 lg:border-y-[3px] border-y-2 bg-gray-200 border-gray-500"></div>
                        </div>
                    </div>
